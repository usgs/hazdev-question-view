...
QuestionView({
  ...
  label:'This IS a question! It is bound anonymously to the callback function.',
  multiSelect:true,
  answers:[
    {
      value:'first-answer',
...
QuestionView({
  ...
  label:'This question uses an "other" box.',
  multiSelect:false,
  answers:[
    {
      value:'first-answer',
...
// Set this question to a variable to use in the callback function.
var question4 = QuestionView({
  el: document.querySelector('.question4'),
  label:'These questions are in a div.',
  multiSelect:true,
  selectedAnswer:[
    'second-answer',
    'fourth-answer'
...
// Bind the callback functions to the change events.
